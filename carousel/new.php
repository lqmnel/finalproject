...
<html lang="en">
  ...
  <body id="home">
    ...
    <?php
      ...
      $query = mysqli_query($conn, 'SELECT * FROM carousel WHERE id = 7');
      ...
      <div class="container">
        <div class="row">
          <div class="col-8">
            ...
            <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" style="width: 700px" />
            <br /><br />
            ...
            <!-- <a href="https://mcity.id/peran-teknologi-informasi-terhadap-pelayanan-publik/#">Referensi Contoh Berita</a> -->
          </div>
          <div class="col-4"></div>
        </div>
      </div>
