        ...
        <div class="row">
          <div class="col-8">
            ...
            <div style="text-align: justify;">
              ...
              <a href="pengertian_print.php" target="_blank" style="color: black;">
                <i class="fa-solid fa-download"></i>
                <span>Download Content</span>
              </a>
            </div>
            <!-- <a href="https://katadata.co.id/sitinuraeni/berita/623d8dfb56e15/pengertian-teknologi-jenis-contoh-dan-manfaatnya">Referensi Contoh Berita</a> -->
          </div>
          <div class="col-4"></div>
        </div>
      </div>
