        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="Page">Melihat Data Konten Catalog</li>
            </ol>
          </nav>
          <h1 class="h2">Melihat Data Konten Catalog</h1>
          <p>Selamat Datang, <?php echo($_SESSION['username']) ?>. Ini adalah halaman untuk melihat data konten catalog</p>

          <div class="card">
            <div class="card-body">
                <div class="mb-3">
                    <label for="catalog_name" class="form-label"><strong>Nama Catalog</strong></label>
                    <input type="text" class="form-control" id="catalog_name" name="catalog_name" placeholder="Nama Catalog" requiered value="<?php echo $catalog_name ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="authors" class="form-label"><strong>Penulis Konten Catalog</strong></label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="judul_catalog" name="judul_catalog" placeholder="Judul Konten Catalog" requiered value="<?php echo $judul_catalog ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="date" class="form-label"><strong>Tanggal Terbit Konten Catalog</strong></label>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="konten_catalog" name="konten_catalog" rows="10" placeholder="" required disabled><?php echo $konten_catalog ?></textarea>
                </div>
                <div class="mb-3">
