...
<body>
    <?php
        ...
        while ($data = mysqli_fetch_array($datas)) {
            ...
            $judul_catalog = $data['judul_catalog'];
            $date = $data['date'];
            $caption = $data['caption'];
            $konten_catalog = $data['konten_catalog'];
        ...
        if(isset($_POST['submit1'])){
            ...
            $sql = "UPDATE catalogs SET catalog_name = '$catalog_name', authors = '$authors', judul_catalog = '$judul_catalog', date = '$date', caption = '$caption', konten_catalog = '$konten_catalog', konten2 = '$konten2', konten3 = '$konten3', konten4 = '$konten4', konten5 = '$konten5', konten6 = '$konten6', konten7 = '$konten7' WHERE id = '$id';";
            $datas = $conn->query($sql);
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="Page">Mengubah Data Konten Catalog</li>
            </ol>
          </nav>
          <h1 class="h2">Mengubah Data Konten Catalog</h1>
            ...
            <div class="card-body">
                <form action="<?php echo $_SERVER['PHP_SELF']."?id=".$id; ?>" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="catalog_name" name="catalog_name" placeholder="Nama Catalog" required value="<?php echo $catalog_name ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="judul_catalog" name="judul_catalog" placeholder="Judul Konten" required value="<?php echo $judul_catalog ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="konten_catalog" name="konten_catalog" rows="10" placeholder="Isi Konten Catalog" required><?php echo $konten_catalog ?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="konten7" name="konten7" rows="10" placeholder="Isi Konten Catalog" require><?php echo $konten7 ?></textarea>
                    </div>
