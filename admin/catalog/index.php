    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
          ...
          <h1 class="h2">Catalog's Content</h1>
          <p>Selamat Datang <?php echo($_SESSION['username']) ?>, ini adalah dashboard Catalog.</p>

            <div class="card">
                <div class="card-body">
                <a href="create.php" class="btn btn-block button-blue mb-4  btn-primary" style="color: white;">Tambah Data Konten Catalog</a>
