        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="Page">Melihat Data Pengguna</li>
            </ol>
          </nav>
          <h1 class="h2">Melihat Data Pengguna</h1>
          <p>Selamat Datang, <?php echo($_SESSION['username']) ?>. Ini adalah halaman untuk melihat data pengguna</p>

          <div class="card">
            <div class="card-body">
                <div class="mb-3">
                    <label for="name" class="form-label"><strong>Nama Pengguna</strong></label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nama" requiered value="<?php echo $name ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="phone" class="form-label"><strong>Nomor Telepon Pengguna</strong></label>
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="name@example.com" requiered value="<?php echo $phone ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label"><strong>Email Pengguna</strong></label>
                    <input type="text" class="form-control" id="email" name="email" placeholder="name@example.com" requiered value="<?php echo $email ?>" disabled>
                </div>
            </div>
          </div>
