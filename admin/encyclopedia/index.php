      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="/finalproject/admin/catalog/">Encyclopedia</a></li>
              <li class="breadcrumb-item active" aria-current="Page">Overview</li>
            </ol>
          </nav>
          <h1 class="h2">Encyclopedia's Content</h1>
          <p>Selamat Datang <?php echo($_SESSION['username']) ?>, ini adalah dashboard Encyclopedia.</p>

            <div class="card">
                <div class="card-body">
                <a href="create.php" class="btn btn-block button-blue mb-4  btn-primary" style="color: white;">Tambah Data Konten Encyclopedia</a>
