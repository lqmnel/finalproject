...
<html lang="en">
  <head>
    ...
    />
    <title>Login Final Project | Luqman Elhakim Ibnu Hasan</title>
    <style>
      body {
      ...
      <div class="row">
        <div class="col-md-6 offset-md-3" style="padding-top: 5rem">
          <div class="card my-5" style="background-color: #22428d">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="card-body cardbodry-color p-lg-5">
              ...
              <div id="emailHelp" class="form-text text-center mb-4 text-light">
                <!-- Not Registered?
                <a href="/finalproject/admin/register.php" class="text-light fw-blod"> Create an Account</a>
                <br /><br /> -->
