        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="Page">Mengubah Data Pengguna</li>
            </ol>
          </nav>
          <h1 class="h2">Mengubah Data Pengguna</h1>
          <p>Selamat Datang, <?php echo($_SESSION['username']) ?>. Ini adalah halaman untuk mengubah data pengguna</p>
            ...
            <div class="card-body">
                <form action="<?php echo $_SERVER['PHP_SELF']."?id=".$id; ?>" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Penulis" required value="<?php echo $name ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="email" name="email" placeholder="name@example.com" required value="<?php echo $email ?>">
                    </div>
