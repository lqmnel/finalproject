...
<body>
    <?php
        ...
        if(isset($_POST['submit1'])){
            ...
            $sql = "INSERT INTO headlines (judul, penulis,date, caption, konten1, konten2, konten3, konten4, konten5, konten6) VALUES ('$judul', '$penulis', '$date', '$caption', '$konten1', '$konten2', '$konten3', '$konten4', '$konten5', '$konten6');";
            ...
            <div class="card-body">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Headline" required>
                    </div>
                    <div class="mb-3">
                        <label for="penulis" class="form-label"><strong>Nama Penulis Headline</strong></label>
                        <input type="text" class="form-control" id="penulis" name="penulis" placeholder="Nama Penulis Headline" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="konten1" name="konten1" rows="10" placeholder="Isi Konten Catalog" required></textarea>
                    </div>
                    <div class="mb-3">
