      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="/finalproject/admin/contact_us/">Contact Us</a></li>
              <li class="breadcrumb-item active" aria-current="Page">Melihat Data Form Contact Us</li>
            </ol>
          </nav>
          <h1 class="h2">Melihat Data Feedback dari Form Contact Us</h1>
          <p>Selamat Datang, <?php echo($_SESSION['username']) ?>. Ini adalah halaman untuk melihat data form contact us</p>

          <div class="card">
            <div class="card-body">
                <div class="mb-3">
                    <label for="nama" class="form-label"><strong>Nama Lengkap</strong></label>
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Lengkap" requiered value="<?php echo $nama ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label"><strong>Email</strong></label>
                    <input type="text" class="form-control" id="email" name="email" placeholder="Email Pemberi Pesan" requiered value="<?php echo $email ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label"><strong>Pesan Feedback</strong></label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="pesan" rows="5" placeholder="<?php echo $pesan ?>" value="" disabled></textarea>
                </div>
            </div>
          </div>
