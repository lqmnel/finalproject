      ...
      <div class="container">
        <div class="row">
          <div class="col-8">
            ...
            >
            <br /><br />
            <img src="https://images.unsplash.com/photo-1519336305162-4b6ed6b6fc83?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="" style="width: 700px" />
            <br /><br />
            <p>
              <?= $data['konten_catalog'] ?>
            </p>
            ...
            <a href="content6_print.php" target="_blank" style="color: black;">
                <i class="fa-solid fa-download"></i>
                <span>Download Content</span>
            </a>
            <!-- <a href="https://kumparan.com/kumparantech/5-brand-hp-terlaris-di-indonesia-oppo-kembali-juara-samsung-turun-takhta-1ytsivy1Tnf">Referensi Contoh Artikel</a> -->
          </div>
          <div class="col-4"></div>
        </div>
      </div>
