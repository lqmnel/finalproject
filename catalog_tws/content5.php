      ...
      <div class="container">
        <div class="row">
          <div class="col-8">
            ...
            >
            <br /><br />
            <img src="https://images.unsplash.com/photo-1577864663715-47341a4f300b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="" style="width: 700px" />
            <br /><br />
            <p>
              <?= $data['konten_catalog'] ?>
            </p>
            ...
            <!-- <a href="https://www.klikdokter.com/info-sehat/berita-kesehatan/benarkah-bluetooth-headphone-membahayakan-kesehatan">Referensi Contoh Artikel</a> -->
          </div>
          <div class="col-4"></div>
        </div>
      </div>
