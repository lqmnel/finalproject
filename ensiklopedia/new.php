      ...
      <div class="container">
        <div class="row">
          ...
          <?php
            ...
            $query = mysqli_query($conn, 'SELECT * FROM encyclopedia WHERE id = 8');
          ...
          ?>
            ...
            <a href="new_print.php" target="_blank" style="color: black;">
          ...
          <?php
            include "../connection.php";
            $query = mysqli_query($conn, 'SELECT * FROM encyclopedia WHERE id = 9');
            while ($data = mysqli_fetch_array($query)) {
          ?>
            <br /><br />
