      ...
      <div class="container">
        <div class="row">
          ...
          ?>
            ...
            <a href="history_print.php" target="_blank" style="color: black;">
                <i class="fa-solid fa-download"></i>
                <span>Download Content</span>
            </a>
            <!-- <a href="https://id.wikipedia.org/wiki/Sejarah_teknologi">Referensi Contoh Berita</a> -->
          </div>
          <?php } ?>
          <div class="col-4 justify-content-center">
          <?php
            include "../connection.php";
            $query = mysqli_query($conn, 'SELECT * FROM encyclopedia WHERE id = 5');
            while ($data = mysqli_fetch_array($query)) {
          ?>
            <br /><br />
            ...
            <br />
            <img src="https://images.unsplash.com/photo-1585496058078-29596a3a7ced?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=327&q=80" alt="" style="width: 350px" />
            <br /><br />
            <img src="https://images.unsplash.com/photo-1512591290618-904e04936827?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="" />
            <br /><br />
            <img src="https://images.unsplash.com/photo-1543240802-ea508bad565c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="" />
          </div>
          <?php } ?>
        </div>
      </div>
